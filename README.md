...
The following modules are currently implemented:
 ...
 - __File Contents (contents)__: Looks for patterns as defined in [data/filecontent.js](data/filename.js) within the contents of files, things like 'password: ', and 'BEGIN RSA PRIVATE KEY' will pop up here.
